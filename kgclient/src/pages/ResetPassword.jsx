...
const ResetPassword = () => {
    ...
    const onSubmitEmail = async (e) => {
        ...
        try{
            ...
            if(response.status === 200){
                toast.success("The OTP for Password reset has sent successfully!");
                setIsEmailSent(true);
            }
            else{
    ...
    const handleVerify = () => {
        ...
        if(otp.length !== 6){
            toast.error("Please enter all the 6 digits of the OTP that was sent to you.")
            return;
        }
    ...
    const onSubmitNewPassword = async (e) => {
        ...
        try{
            ...
            if(response.status === 200){
                toast.success("The password reset was done successfully!");
                navigate("/login");
            }
            else{
                toast.error("Something went wrong. Please try again!");
